...
public:
    ForwardController() : Node("forward_controller")
    {
        ...
        imu_sub_ = create_subscription<sensor_msgs::msg::Imu>(
            "/imu", 10, std::bind(&ForwardController::imuCallback, this, std::placeholders::_1));
        ...
        RCLCPP_INFO(get_logger(), "Forward Controller started with IMU-based slip correction!");
    }
